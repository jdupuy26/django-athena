...
urlpatterns = [
    ...
    path('codes/<int:pk>-clone', views.CodeDetailView.as_view(
        template_name='athena_code/code_clone_detail.html'), name='code-clone-detail'
    ),
    ...
    path('configuration/create/', views.ConfigurationCreate.as_view(), name='configuration-create'),
    path(
