...
from athena_code.models import Repo, Fork, Code, Branch
                ...
                if rf.ok:
                    ...
                    for fork in forks:
                        if fork['owner']['login'] in GH_USERS:
                            ...
                            self.stdout.write(
                                "[generate_fixture]: Added fork '{}' to the db".format(
                                    myfork.name
                            ))
                    ...
                    self.stdout.write("[generate_fixture]: Request at url: '{}' not valid".format(
                        GH_URL + "/forks"
                    ))
            else:
                self.stdout.write("[generate_fixture]: Request at url: '{}' not valid".format(
